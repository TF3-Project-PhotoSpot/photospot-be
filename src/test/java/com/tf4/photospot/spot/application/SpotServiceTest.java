...
class SpotServiceTest {
	...
	class NearbySpotTest {
		...
		void getNearbySpotWithinRadius() {
			...
			Spot centerSpot = new Spot("서울시 도봉구 마들로 646", centerCoord);
			Spot innerSpot = new Spot("중심에서 도보 3.8km", convert(127.0273281, 37.6400187));
			Spot outerSpot = new Spot("중심에서 도보 5.8km", convert(127.0467641, 37.7155734));
	...
	class FindSpot {
		...
		void findRegisteredSpot() {
			//given
			var coord = convert(127.046817765572, 37.6676198504815);
			var spot = new Spot("서울시 마들로 646", coord);
