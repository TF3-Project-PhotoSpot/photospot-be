...
public class QPhoto extends EntityPathBase<Photo> {
    ...
    private static final long serialVersionUID = 1968564695L;
    ...
    public QPhoto(Class<? extends Photo> type, PathMetadata metadata, PathInits inits) {
        ...
        this.bubble = inits.isInitialized("bubble") ? new QBubble(forProperty("bubble")) : null;
    }
